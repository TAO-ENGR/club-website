...
export default function Experience_TL() {
  ...
  return (
    <main className="bg-slate-50 flex min-h-screen flex-col gap-12">
      ...
      <h1 className="text-slate-950 md:text-4xl text-3xl text-left font-bold items-start px-8 lg:px-24" style={poppins.style}>RESOURCES</h1>
      ...
      <div className="bg-maroon w-full md:h-[23.5rem] flex justify-between overflow-hidden">
        ...
        <div>
          ...
          <h3 className="text-lightGray lg:text-[1.2rem] lg:line-height-[1.75rem] md:text-l font-bold px-8 lg:px-24 pt-9
          pb-0">SPRING 2023 ENGR 216 FINAL</h3>
          <h3 className="text-lightGray lg:text-[1.2rem] lg:line-height-[1.75rem] d:text-l font-bold px-8 lg:px-24  pt-0
      ...
      <div className="w-full">
        <h2 className='text-slate-950 md:text-4xl text-3xl text-left font-bold items-start uppercase mb-8 px-8 lg:px-24' style={poppins.style}>
            Material Hubs
        </h2>
      
        <div className='bg-[#EBEBEB] rounded-xl flex flex-col md:flex-row gap-8 items-center justify-between p-8 mx-8 lg:mx-24'>
