...
export default function Home() {
    return (
        <main className="flex flex-col md:flex-row bg-white px-24 py-32">
            <div className="md:pr-32">
                ...
                <p className="lg:text-xl md:text-lg font-light">Don't have a discord? Visit <a href="https://www.discord.com" target="_blank" rel="noopener noreferrer"><u>discord.com</u></a> to</p>
            ...
            <div className="flex-auto lg:items-center flex justify-center items-center">
                <a href="https://www.tx.ag/taoserver" target="_blank" rel="noopener noreferrer">
