...
export default function Fall24ReviewsFooter() {
  return (
    <footer className="absolute z-100 w-full items-start justify-between bg-black text-white lg:text-base md:text-md text-sm grid grid-rows-2 md:grid-cols-5 grid-cols-2 gap-8 lg:p-24 lg:ps-24 lg:pe-24 md:p-8 md:ps-8 md:pe-16 p-8 ps-8 pe-8">
      <div
